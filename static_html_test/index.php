...
<head>
    ...
    <meta name="csrf-token" content="WnBVMWlWLUgNBxJLPy4aAA8KLH0gO14SGzQFfQwVHiIUQgReDzd8MQ==">
    <title>My Yii Application</title>
    <link href="/agrimooc/advanced/frontend/web/assets/7b63017d/css/bootstrap.css" rel="stylesheet">
<link href="/agrimooc/advanced/frontend/web/css/site.css" rel="stylesheet"></head>
<body>
        <div class="wrap">
        <nav id="w0" class="navbar-inverse navbar-fixed-top navbar" role="navigation"><div class="container"><div class="navbar-header"><button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#w0-collapse"><span class="sr-only">Toggle navigation</span>
<span class="icon-bar"></span>
<span class="icon-bar"></span>
<span class="icon-bar"></span></button><a class="navbar-brand" href="/agrimooc/advanced/frontend/web/index.php">My Company</a></div><div id="w0-collapse" class="collapse navbar-collapse"><ul id="w1" class="navbar-nav navbar-right nav"><li class="active"><a href="/agrimooc/advanced/frontend/web/index.php?r=site%2Findex">Home</a></li>
<li><a href="/agrimooc/advanced/frontend/web/index.php?r=site%2Fabout">About</a></li>
<li><a href="/agrimooc/advanced/frontend/web/index.php?r=site%2Fcontact">Contact</a></li>
<li><a href="/agrimooc/advanced/frontend/web/index.php?r=site%2Flogout" data-method="post">Logout (len)</a></li></ul></div></div></nav>
        <div class="container">
    ...
    <div id="yii-debug-toolbar" data-url="/agrimooc/advanced/frontend/web/index.php?r=debug%2Fdefault%2Ftoolbar&tag=5593d9a41c8f1" style="display:none"></div><style>#yii-debug-toolbar {
    padding: 0;
...
</script><script src="/agrimooc/advanced/frontend/web/assets/e875acd9/jquery.js"></script>
<script src="/agrimooc/advanced/frontend/web/assets/225ffab4/yii.js"></script>
<script src="/agrimooc/advanced/frontend/web/assets/7b63017d/js/bootstrap.js"></script></body>
</html>
